...
<div class="container has-text-centered" >
    ...
    <div class="columns is-justified" >
        <div class="column is-6 has-text-right" @click="$emit('toggleModal', '<?php echo $mccarthyVideo['video_type']; ?>', '<?php echo $mccarthyVideo['video_code']; ?>')" >
            <a class="image-link" >
        ...
        <div class="column is-6 has-text-right" @click="$emit('toggleModal', '<?php echo $harrodVideo['video_type']; ?>', '<?php echo $harrodVideo['video_code']; ?>')" >
            <a class="image-link" >
