<div class="appointment-box-container has-text-centered">
    ...
    <p>When you’re pain free, everything gets better. Start by requesting an appointment at The Spine Center:</p>
        ...
        <div class="columns is-justified is-multiline">
            ...
            <div class="column is-12">
                <div class="control">
                    ...
                    <label class="radio">
                        <input type="radio" name="newsletter_signup" checked value="yes">
                        Yes
                    </label>
                    <label class="radio">
