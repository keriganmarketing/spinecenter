...
<table
    ...
    <tbody>
    <tr>
        <td style="padding:20px; border:1px solid #ddd; border-top:10px solid #000000; border-bottom: 0;" >
            <h2>{headline}</h2>
            <p>{introcopy}</p>
    ...
    <tr>
        <td style="border-bottom: #E6E2B7 solid 2px; border-left:1px solid #ddd; border-right:1px solid #ddd; padding:10px;">
