<div class="container has-text-centered" >
    ...
    <div class="columns is-justified" >
        <div class="column is-6 has-text-right" >
            ...
            <a class="video-button button is-rounded is-primary is-glass" href="#" >PLAY&nbsp;<i class="fa fa-play" aria-hidden="true"></i></a></a>
        </div>
        <div class="column is-6 has-text-right" >
            <a class="image-link" href="#" >
    ...
    <a href="#" class="button is-white is-outlined is-rounded" >Watch more helpful videos</a>
</div>